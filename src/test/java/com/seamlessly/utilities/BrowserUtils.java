...
public class BrowserUtils {
    ...
    /**
     *This method will verify if the current URl contains expected value and verify actual URL contains the value
     * @param expectedInUrl
     */
    ...
    /**
     * This method accept a dropdown a a Webelement and return all of the options' text in a list of String
